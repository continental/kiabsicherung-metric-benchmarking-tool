# Contributing to Metric Benchmarking Tool
...
You can monitor issues and help other people who have questions about contributing to Metric Benchmarking Tool or using it for their projects.
...
1. Update the README.md with details of changes to the interface, this includes new environment variables, exposed ports, useful file locations and configuration parameters.
2. Document changes made in the [CHANGELOG](CHANGELOG.md) file under the section [Unreleased].
3. Once you have the sign-off of at least one maintainer from the Continental organization, you may request the second reviewer to merge the Pull Request for you.
4. Sign a Contributor License Agreement (CLA).

Concerning a pull request, feedback from the maintainers should usually be provided within a time frame of 10 working days.
...
2. If you need help getting started or implementing a change, open an issue with your question. If there is already an issue open for the feature you're working on, you can post there.
